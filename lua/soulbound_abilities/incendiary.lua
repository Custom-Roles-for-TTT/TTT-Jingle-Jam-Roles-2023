...
if SERVER then
    ...
    hook.Add("TTTPrepareRound", "Soulbound_Incendiary_TTTPrepareRound", function()
        for _, p in ipairs(player.GetAll()) do
            p:SetNWInt("TTTSoulboundIncendiaryUses", 0)
            p:SetNWFloat("TTTSoulboundIncendiaryNextUse", 0)
        end
    end)
end
